    ...
    var heatmapFactory = (function() {
        ...
        legend.prototype = {
            init: function() {
                ...
                element.style.cssText = "border-radius:5px;position:absolute;" + positionCss + "font-family:Helvetica; width:275px;z-index:10000000000; background:rgba(255,255,255,1);padding:10px;border:1px solid black;margin:0;";
        ...
        heatmap.prototype = {
            configure: function(config) {
                ...
                me.set("max", config.max || false); //          //blue                  //light blue            //green
                me.set("gradient", config.gradient || { 0.25: "rgb(0,0,255)", 0.35: "rgb(0,255,255)", 0.60: "rgb(0,255,0)", 0.85: "yellow", 0.95: "rgb(255,0,0)" }); // default is the common blue to red gradient
            ...
            drawAlpha: function(x, y, count, colorize) {
                ...
                ctx.beginPath();
                ctx.arc(x - 15000, y - 15000, radius, 0, 2 * Math.PI);
                ctx.closePath();
                ctx.fill();
                if (colorize) {
