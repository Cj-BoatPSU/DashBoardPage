    ...
    var heatmapFactory = (function() {
        ...
        heatmap.prototype = {
            configure: function(config) {
                ...
                me.set("max", config.max || false); //red
            ...
            initColorPalette: function() {
                ...
                testData.data[1] = testData.data[2] = 64; // 0% blue & green
