...
var circleDonutChart = function(chartElementID) {
    ...
    function textSetter(DOM, text) {
        ...
        if ((text >= 1000) && (textScaling = 1)) {
            ...
            tNumberDOM.setAttribute('font-size', 40 * scaling * textScaling);
    ...
    this.draw = function(options) {
        ...
        if (!oTester.size) {
            ...
            options.size = 220 * options.scaling;
        }
        ...
        titleDOM.setAttribute('font-size', 14 * options.scaling);
        titleDOM.setAttribute('fill', "black"); //set color font
        titleDOM.setAttribute('font-family', 'arial');
        titleDOM.setAttribute('font-weight', 'bold');
